...
<ul class="nav nav-tabs menu-tabs">
   <li class="nav-item active">
      <a class="nav-link" href="booking/total-report">All Booking <span class="badge badge-primary">550</span></a>
   </li>
   <li class="nav-item">
                        ...
                        <table class="table table-hover table-center mb-0 datatable dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                           <thead>
                              <tr role="row">
                                 ...
                                 <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Booking Status: activate to sort column ascending" style="width: 72.75px;">Booking Status</th>
