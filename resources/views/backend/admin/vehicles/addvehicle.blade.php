                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="veh_make">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Vehicle Model</label>
                            <input class="form-control" type="text" name="veh_model">
                        </div>
                    </div>
                </div>
                <!-- <div class="row">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" id="inlineFormInputGroup" placeholder="From (km)" min="1" max="100">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" id="to" placeholder="TO" min="1" max="100">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" id="price_per_km" placeholder="Price per Km" min="1" max="100">
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Description</label>
                                <textarea class="form-control col-xs-12" name="veh_desc"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
