			...
			<div class="row" style="margin-top:100px;">
                ...
                <div class="content">
					...
					<article class="single" id="tab1">
						<div class="box">
					        <header class="f-title color">Register Agency</header>
							<fieldset>
								<div class="f-row">
									<div class="one-half">
                                ...
                                <header class="f-title color">Agency Contract Information</header>
							    <div class="f-row">
									<div class="one-half">
									...
									<div class="one-half">
										<label for="password1">UpCell Commission</label>
